...
const translations = {
  ar: {
    ...
    "faq.a2": "يعتمد ذلك على حجم المشروع ومتطلباته، ولكن عادة ما يستغرق الموقع التعريفي من أسبوع إلى أسبوعين، بينما المتجر الإلكتروني قد يستغرق من 3 إلى 4 أسابيع.",
  ...
  en: {
    ...
    "faq.a2": "It depends on the project's size and requirements, but typically a portfolio website takes 1-2 weeks, while an e-commerce store may take 3-4 weeks.",
