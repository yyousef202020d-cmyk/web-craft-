...
const translations = {
  ar: {
    ...
    "hero.cta1": "تصفح خدماتي",
    "hero.cta2": "تواصل معي",
    "services.title": "خدماتي المميزة",
    "services.desc": "أقدم مجموعة متكاملة من الخدمات الرقمية لمساعدتك في الظهور بأفضل شكل على الإنترنت.",
    ...
    "services.cv.desc": "سيرة ذاتية رقمية تفاعلية تميزك عن الآخرين وتبرز مهاراتك بشكل عصري وجذاب.",
    ...
    "contact.desc": "هل لديك فكرة مشروع؟ تواصل معي وسأساعدك في تحويلها إلى واقع.",
    "contact.name": "الاسم",
  ...
  en: {
    ...
    "services.title": "My Featured Services",
    ...
    "contact.desc": "Have a project idea? Contact me and I'll help turn it into reality.",
    "contact.name": "Name",
    "contact.email": "Email",
