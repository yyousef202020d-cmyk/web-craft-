...
const translations = {
  ar: {
    ...
    "hero.title1": "نحول أفكاركم إلى",
    "hero.title2": "واقع رقمي مذهل",
    "hero.desc": "بناء واجهات عصرية، سريعة، وجذابة. نساعدكم في الظهور بأفضل شكل على الإنترنت من خلال تصاميم فريدة وأداء استثنائي.",
    "hero.cta1": "تصفح خدماتنا",
    "hero.cta2": "تواصل معنا",
    "services.title": "خدماتنا المميزة",
    "services.desc": "نقدم مجموعة متكاملة من الخدمات الرقمية لمساعدتكم في الظهور بأفضل شكل على الإنترنت.",
    "services.web.title": "تصميم وتطوير المواقع",
    "services.web.desc": "مواقع عصرية متجاوبة مع جميع الشاشات، سريعة التحميل، ومصممة بأحدث التقنيات لتعكس هويتكم أو علامتكم التجارية.",
    "services.portfolio.title": "معرض الأعمال (Portfolio)",
    "services.portfolio.desc": "مساحة خاصة لاستعراض مشاريعكم وإنجازاتكم بطريقة احترافية تجذب العملاء وأصحاب العمل.",
    ...
    "contact.desc": "هل لديكم فكرة مشروع؟ تواصلوا معنا وسنساعدكم في تحويلها إلى واقع.",
    "contact.name": "الاسم",
