...
const translations = {
  ar: {
    ...
    "faq.q1": "لماذا أختار 'ويب كرافت' بدلاً من أدوات الذكاء الاصطناعي؟",
    "faq.a1": "أدوات الذكاء الاصطناعي تعطي قوالب جاهزة ونتائج عامة، لكن في 'ويب كرافت' أنت تستثمر في فريق متكامل يدرس احتياجات مشروعك ويصمم لك هوية رقمية فريدة. نحن نقدم لك دعماً فنياً مستمراً، تعديلات مرنة بناءً على رؤيتك، تحسيناً حقيقياً لمحركات البحث (SEO)، وضماناً لأداء الموقع وسرعته. الذكاء الاصطناعي أداة، لكننا نضع اللمسة البشرية والخبرة التقنية لنضمن نجاح مشروعك.",
    "faq.q2": "كم يستغرق تصميم موقع إلكتروني؟",
    "faq.a2": "يعتمد ذلك على حجم المشروع ومتطلباته، ولكن عادة ما يستغرق الموقع التعريفي من يومين إلى أسبوع، بينما المتجر الإلكتروني قد يستغرق من يومين إلى أسبوع ونصف.",
    "faq.q3": "هل توفرون خدمة الدعم الفني بعد التسليم؟",
    "faq.a3": "نعم، نقدم دعماً فنياً لضمان عمل الموقع بشكل مثالي، وتختلف مدة الدعم المجاني حسب الباقة المختارة.",
    "faq.q4": "هل يمكنني تعديل محتوى الموقع بنفسي؟",
    "faq.a4": "بالتأكيد! في الباقات التي تتضمن لوحة تحكم، يمكنك تعديل النصوص والصور والمنتجات بسهولة تامة.",
    "faq.q5": "هل تقدمون خدمات الاستضافة والدومين؟",
    "faq.a5": "نعم، نساعدك في اختيار وحجز أفضل استضافة واسم نطاق (دومين) يناسب مشروعك وميزانيتك، وبعض الباقات تتضمن دومين مجاني.",
    ...
    "contact.success": "تم إرسال الرسالة بنجاح وسيتم الرد عليك خلال دقائق ✨",
    "contact.note": "تقدر كمان تبعتلنا رسالة على انستجرام، تيك توك، أو واتساب، وهنرد عليك فوراً ونبدأ نشتغل على مشروعك 🚀",
  ...
  en: {
    ...
    "faq.q1": "Why choose 'Web Craft' over AI website builders?",
    "faq.a1": "AI tools provide generic templates, but with 'Web Craft', you're investing in a dedicated team that understands your project's unique needs. We deliver a custom digital identity, ongoing technical support, flexible revisions, real SEO optimization, and guaranteed performance. AI is just a tool; we provide the human touch and technical expertise to ensure your success.",
    "faq.q2": "How long does it take to design a website?",
    "faq.a2": "It depends on the project's size and requirements, but typically a portfolio website takes 2 days to 1 week, while an e-commerce store may take 2 days to 1.5 weeks.",
    "faq.q3": "Do you provide technical support after delivery?",
    "faq.a3": "Yes, we offer technical support to ensure your website runs perfectly. The free support duration depends on the chosen package.",
    "faq.q4": "Can I edit the website content myself?",
    "faq.a4": "Absolutely! For packages that include a dashboard, you can easily manage texts, images, and products seamlessly.",
    "faq.q5": "Do you offer hosting and domain services?",
    "faq.a5": "Yes, we help you choose and register the best hosting and domain name that fits your project. Some packages include a free domain.",
    ...
    "contact.note": "You don't have to send your message from here! You can also reach out to us on Instagram, TikTok, or WhatsApp. We'll reply immediately and start working on your project 🚀",
