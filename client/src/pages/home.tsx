        ...
        <div className="container relative z-10 px-6 text-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 text-primary mb-6 animate-pulse">
              ...
              <span className="text-sm font-medium">متاح للعمل الحر</span>
            </div>
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto mb-10 leading-relaxed">
              أنا مطور ويب متخصص في بناء واجهات عصرية، سريعة، وجذابة. سواء كنت تحتاج موقعاً شخصياً، بورتفوليو، أو سيرة ذاتية تفاعلية.
            </p>

            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <Button size="lg" className="rounded-full text-lg h-14 px-8 w-full sm:w-auto glow">
                تصفح خدماتي
                <ArrowLeft className="mr-2 h-5 w-5" />
              </Button>
              <Button size="lg" variant="outline" className="rounded-full text-lg h-14 px-8 w-full sm:w-auto bg-background/50 backdrop-blur-xs border-white/10 hover:bg-white/5">
                تواصل معي
              </Button>
            </div>
          </motion.div>
      ...
      <section className="py-24 border-y border-border/50 bg-background">
        <div className="container px-6 mx-auto">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative h-[400px] rounded-2xl overflow-hidden border border-white/10 bg-muted/20 flex items-center justify-center group">
               ...
               <div className="relative text-center p-8 border border-white/10 bg-background/50 backdrop-blur-md rounded-xl max-w-xs transform group-hover:scale-105 transition-transform duration-500">
              ...
              <form className="space-y-6">
                <div className="grid md:grid-cols-2 gap-6">
                  <div className="space-y-2">
                    ...
                    <Input placeholder="أدخل اسمك" className="bg-background/50 border-white/10 h-12" />
                  </div>
                  <div className="space-y-2">
                    <label className="text-sm font-medium">البريد الإلكتروني</label>
                    <Input placeholder="example@email.com" type="email" className="bg-background/50 border-white/10 h-12" />
                  </div>
                </div>
                <div className="space-y-2">
                  <label className="text-sm font-medium">الرسالة</label>
                  <Textarea placeholder="تفاصيل مشروعك..." className="bg-background/50 border-white/10 min-h-[150px] resize-none" />
                </div>
                <Button size="lg" className="w-full h-12 text-lg font-bold rounded-xl glow">
                  إرسال الرسالة
                </Button>
              </form>
            </CardContent>
